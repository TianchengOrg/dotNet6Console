...
public class HttpUtillib
{
    ...
    private static void initRequest(Dictionary<string, string> header, string url, string body, bool isPost)
    {
        ...
        if (_isHttps)
        {
            ...
            //ServicePointManager.SecurityProtocol = (SecurityProtocolType)48 | (SecurityProtocolType)3072 | (SecurityProtocolType)768 | (SecurityProtocolType)192 | (SecurityProtocolType)12288;
